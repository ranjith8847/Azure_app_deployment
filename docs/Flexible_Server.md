...
### Copy the server name from the deployed PostgreSQL server
...
- After adding your IP and credentials, click **Test Connection** — it should now connect to your PostgreSQL database.
